...
// import { getChatMessages } from "../../../../../utils/APIs/chatApis";
...
//   /* =========================
//      RESOLVE ACTIVE CHAT ID
//      (BOOKING ID OR QUOTE ID)
//   ========================= */
//   const activeChatId =
//     quoteId ||                     // /chat/:quoteId
//     routeBookingId ||              // /bookingChat/:bookingId
//     bookingId ||                   // from AllBookings tab
...
//     };
//   }, [activeChatId, currentUserId, navigate]);
...
//       bookingId: activeChatId, // 🔑 BACKEND EXPECTS bookingId ONLY
//       message: input,
//       type: "text",
//     });
...
//     try {
//       setLoading(true);
//       await updateQuoteStatus(activeChatId, {
...
//                           <span className="status-text">Receive</span>
//                         </div>
//                       </div>

//           <div className="status-indicator-payment">
//             <button className="Accept-chat-payment-btn">Accept</button>
//             <button className="Reject-chat-payment-btn" onClick={handleRejectClick}>Reject</button>
//           </div>
//             </div>
...
const handleAcceptClick = async (msg) => {
  try {
    ...
    if (res?.data?.success) {
      ...
      navigate("/payment-details", {
        state: {
          serviceCost: msg.budget,
          bookingId: bookingId,   // ✅ ONLY bookingId now
        },
      });
    }
  ...
  const handleSend = () => {
    ...
    // SocketService.sendMessage({
    //   // bookingId: activeChatId, // 🔑 BACKEND EXPECTS bookingId ONLY
    //   quoteId: activeChatId, // 🔑 BACKEND EXPECTS bookingId ONLY
    //   message: input,
    //   type: "text",
    // });
    sendMessageApi(
      // bookingId: activeChatId, // 🔑 BACKEND EXPECTS bookingId ONLY
       activeChatId, // 🔑 BACKEND EXPECTS bookingId ONLY
       input,
       "text"
    );
    ...
    <div className="chat-wrapper">
      ...
      <div className="chat-body">
        {messages.map((msg, index) => {
          ...
          <div className="status-indicator-payment">
            <button className="Accept-chat-payment-btn"  onClick={() => handleAcceptClick(msg)}>Accept</button>
            <button className="Reject-chat-payment-btn" onClick={handleRejectClick}>Reject</button>
          </div>
            </div>
